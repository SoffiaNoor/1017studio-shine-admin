                            ...
                            <div class="w-full xl:w-1/2">
                                <div class="w-full p-4 sm:p-12.5 xl:p-17.5">
                                    ...
                                    <form role="form" method="POST" action="{{route('register')}}">
                                        @csrf
                                        <div class="mb-4">
                                            <div class="font-bold text-3xl text-white">Register your Account</div>
                                        </div>
                                        <div class="mb-4">
                                            <label
                                                class="mb-2.5 block font-medium text-white dark:text-white">Username</label>
                                            <div class="relative">
                                                <input type="name" placeholder="Enter your username" name="username"
                                                    id="username"
                                        ...
                                        <div class="mb-4">
                                            <label
                                                class="mb-2.5 block font-medium text-white dark:text-white">Name</label>
                                            <div class="relative">
                                        ...
                                        <div class="mb-4">
                                            <label
                                                class="mb-2.5 block font-medium text-white dark:text-white">Email</label>
                                            <div class="relative">
                                        ...
                                        <div x-data="{modalIsOpen: false}">
                                            <button @click="modalIsOpen = true" type="submit"
