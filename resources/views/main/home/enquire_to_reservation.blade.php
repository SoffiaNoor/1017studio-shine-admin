<div class="grid grid-cols-1 py-4 gap-8">
    <div class="col-span-12">
        <form method="POST" action="{{ route('storeEnquire',$reservation->id)}}" enctype="multipart/form-data">
            @csrf
            @method('PUT')
                ...
                <div class="p-7">
                    ...
                    <div class="mb-5.5">
                        ...
                        <div class="relative">
                            ...
                            <textarea class="@error('description') is-invalid @enderror" name="description_reservation"
                                style="display:none;">{{$reservation->description}}</textarea>
                        </div>
                    </div>
...
<script>
    const editor2 = pell.init({
      ...
      onChange: function (html) {
          document.querySelector(`textarea[name="description_reservation"]`).value = html;
      },
      styleWithCSS: true,
      actions: [
          'bold',
  ...
  editor2.content.innerHTML = `{!! $reservation->description !!}`;
</script>