<div x-data="{ loaded: true }" x-show="loaded" x-transition:enter="translate-y-0"
  x-transition:leave="transition-transform duration-500 ease-in-out -translate-y-full"
  x-init="setTimeout(() => loaded = false, 500)"
  class="fixed left-0 top-0 z-999999 flex h-screen w-screen items-center justify-center bg-boxdark">
