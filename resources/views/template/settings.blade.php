                  ...
                  <div class="p-7">
                    <form action="#">
                        ...
                        <div class="w-full sm:w-1/2">
                          ...
                          <div class="relative">
                            ...
                            <input
                              ...
                              type="text" name="fullName" id="fullName" placeholder="Devid Jhon" value="Devid Jhon" />
                          </div>
                        </div>
                      ...
                      <div class="mb-5.5">
                        ...
                        <input
                          class="w-full rounded border border-stroke bg-gray px-4.5 py-3 font-medium text-black focus:border-primary focus-visible:outline-none dark:border-strokedark dark:bg-meta-4 dark:text-white dark:focus:border-primary"
                          type="text" name="Username" id="Username" placeholder="devidjhon24" value="devidjhon24" />
                      </div>
