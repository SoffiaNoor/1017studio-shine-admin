              ...
              <div class="hidden w-full xl:block xl:w-1/2">
                <div class="px-26 py-17.5 text-center">
                  <a class="mb-5.5 inline-block" href="index.html">
                    <img class="hidden dark:block" src="{{asset('assets/images/logo/logo.png')}}" alt="Logo" />
                    <img class="dark:hidden" src="{{asset('assets/images/logo/logo-icon.png')}}" alt="Logo" />
                  </a>
                </div>
              </div>
